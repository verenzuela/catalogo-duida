    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>Catalogo</b>Duida</span>
        </a>
...
<div class="user-panel">
    ...
    <?php endif;?>
      ...
      <section class="content">
        ...
        <strong>Copyright &copy; 2019<a href="http://catalogo-duida.verenzuela.com" target="_blank">catalogo-duida.verenzuela.com</a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
      <div class="login-logo">
        <a href="./"><b>Catalogo</b>Duida</a>
      </div><!-- /.login-logo -->
