...
<html lang="es">
  <head>
    ...
    <title>Duida | Catalogo en Linea</title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3 col-xs-5">
            <br><h1><a href="/" style="text-decoration: none" ><?php echo $title; ?></a></h1>
          </div>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav">
            ...
            <?php endif; ?>
            <li><a href="index.php?view=descarga"><i class="fa fa-list"></i> Listado</a></li>
    ...
    <section>
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            <hr>
            <p><b>Catalogo-Duida</b> v1.1 &copy; 2019</p>
            <p class="text-muted">Desarrollado por: <a href="http://www.verenzuela.com" target="_blank">www.verenzuela.com</a></p>
          </div>
        </div>
      </div>
    </section>
